...
def registrar_equipo(nombre, equipo_id, descripcion):
    ...
    with open(r'C:\Users\Bas\PycharmProjects\GestorDeProyectos\gestor\resources\equipos.json', "r",
    ...
    with open(r'C:\Users\Bas\PycharmProjects\GestorDeProyectos\gestor\resources\equipos.json', "w",
              encoding="utf-8") as archivo:
